...
{
    public class IceHerringMinion : HerringMinion
    {
		...
		public override void AI()
		{
			...
			bool num3 = ((ModProjectile)this).Projectile.type == ModContent.ProjectileType<IceHerringMinion>();
			val.AddBuff(ModContent.BuffType<IceHerringBuff>(), 3600, true, false);
			//YagoisCalmityAdditionsPlayer modPlayer = player.GetModPlayer<YagoisCalmityAdditionsPlayer>();
			if (num3)
			{
				if (val.dead)
				{
					modPlayer.IceHerring = false;
				}
