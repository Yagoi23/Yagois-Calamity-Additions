...
{
	public class ShadowHerringStaff : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shadow Herring Staff");
			Tooltip.SetDefault("Summons an shadow herring to fight for you\nEach herring takes only half of a minion slot");
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = ModContent.ProjectileType<ShadowHerringMinion>();
			Item.shootSpeed = 10f;
