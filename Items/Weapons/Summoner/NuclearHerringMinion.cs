...
{
    public class NuclearHerringMinion : HerringMinion
    {
		...
		public override void AI()
		{
			...
			bool num3 = ((ModProjectile)this).Projectile.type == ModContent.ProjectileType<NuclearHerringMinion>();
			val.AddBuff(ModContent.BuffType<NuclearHerringBuff>(), 3600, true, false);
			//YagoisCalmityAdditionsPlayer modPlayer = player.GetModPlayer<YagoisCalmityAdditionsPlayer>();
			if (num3)
			{
				if (val.dead)
				{
					modPlayer.NuclearHerring = false;
				}
