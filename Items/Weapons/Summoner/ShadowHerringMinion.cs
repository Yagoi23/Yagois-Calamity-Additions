...
{
    public class ShadowHerringMinion : HerringMinion
    {
		...
		public override void AI()
		{
			...
			bool num3 = ((ModProjectile)this).Projectile.type == ModContent.ProjectileType<ShadowHerringMinion>();
			val.AddBuff(ModContent.BuffType<ShadowHerringBuff>(), 3600, true, false);
			//YagoisCalmityAdditionsPlayer modPlayer = player.GetModPlayer<YagoisCalmityAdditionsPlayer>();
			if (num3)
			{
				if (val.dead)
				{
					modPlayer.ShadowHerring = false;
				}
