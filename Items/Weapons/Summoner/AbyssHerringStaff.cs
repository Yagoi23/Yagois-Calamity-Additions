...
{
	public class AbyssHerringStaff : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Abyss Herring Staff");
			Tooltip.SetDefault("Summons an abyssal herring to fight for you\nEach herring takes only half of a minion slot");
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = ModContent.ProjectileType<AbyssHerringMinion>();
			Item.shootSpeed = 10f;
