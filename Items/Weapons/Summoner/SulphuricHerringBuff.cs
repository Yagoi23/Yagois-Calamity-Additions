...
{
	public class SulphuricHerringBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex)
		{
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<SulphuricHerringMinion>()] > 0)
			{
				modPlayer.SulphuricHerring = true;
			}
