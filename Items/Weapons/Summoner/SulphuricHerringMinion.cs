...
{
    public class SulphuricHerringMinion : HerringMinion
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sulphuric Herring");
		...
		public override void AI()
		{
			...
			bool num3 = ((ModProjectile)this).Projectile.type == ModContent.ProjectileType<SulphuricHerringMinion>();
			val.AddBuff(ModContent.BuffType<SulphuricHerringBuff>(), 3600, true, false);
			//YagoisCalmityAdditionsPlayer modPlayer = player.GetModPlayer<YagoisCalmityAdditionsPlayer>();
			if (num3)
			{
				if (val.dead)
				{
					modPlayer.SulphuricHerring = false;
				}
				if (modPlayer.SulphuricHerring)
				{
