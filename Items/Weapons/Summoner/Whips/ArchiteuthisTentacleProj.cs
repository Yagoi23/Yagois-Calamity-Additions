...
{
	public class ArchiteuthisTentacleProj : ModProjectile
	{
		//public override string Texture => "YagoisCalmityAdditions/Items/Weapons/Summoner/Whips/ExampleWhipProjectile";
